...
call_user_func(function ($extKey ='ucph_ce_tables', $contentType ='table') {
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTCAcolumns('tt_content', [
        ...
        'tx_ucph_ce_tables_enable_datatable' => [
            'exclude' => true,
        ...
        'tx_ucph_ce_tables_datatable_columnpicker' => [
            'displayCond' =>'FIELD:tx_ucph_ce_tables_enable_datatable:=:1',
            'exclude' => true,
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addFieldsToPalette(
        ...
        '--linebreak--,tx_ucph_ce_tables_enable_datatable,tx_ucph_ce_tables_datatable_columnpicker,tx_ucph_ce_tables_datatable_columnsort', // New TCA
